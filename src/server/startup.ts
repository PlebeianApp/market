...
import { APP_PRIVATE_KEY, RELAY_URL, setAppPublicKey, setAppSettings, setEventHandlerReady, AUCTION_WHITELIST_MODE, AUCTION_WHITELIST_PUBKEYS } from './runtime'
	...
	const initPromise = getEventHandler()
		.initialize({
			...
			auctionWhitelist: {
				...
				pubkeys: AUCTION_WHITELIST_PUBKEYS,
			},
		})
		.then(() => {
