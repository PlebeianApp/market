...
export function Header() {
	...
	return (
		<header
			className={`sticky top-0 z-50 text-white px-4 ${isCommunityOrNostrPage ? 'bg-black max-lg:hidden' : getHeaderBackground()}`}
				...
				<section className="inline-flex items-center">
					...
					<div className="hidden sm:flex mx-8 gap-8">
						...
						<Link
							to="/nostr"
 						search={{
 							view: undefined // Always go to global/default feed; follows feed removed
 						}}
							className="hover:text-secondary"
							activeProps={{
								className: 'text-secondary',
