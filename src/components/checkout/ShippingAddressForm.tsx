...
export function ShippingAddressForm({ form, hasAllShippingMethods }: ShippingAddressFormProps) {
	...
	// Check if all shipping methods are pickup type
	useEffect(() => {
		const checkPickupStatus = async () => {
			...
			setIsAllPickup(pickupChecks.every(Boolean))
		}
			...
			>
				...
				{isAllPickup && (
					<div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
						...
						<p className="text-sm text-blue-700 mt-1">All items in your order are for pickup. No shipping address is required.</p>
					</div>
				)}
