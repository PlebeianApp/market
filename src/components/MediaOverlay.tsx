	...
	return (
		<DialogPrimitive.Root open={open} onOpenChange={onOpenChange}>
			<DialogPrimitive.Portal>
				...
				{/* Content */}
				<DialogPrimitive.Content className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={() => onOpenChange(false)}>
					...
					>
						{isVideo ? (
							<video src={src} controls className="max-h-[90vh] max-w-[90vw] object-contain" preload="metadata" />
						) : (
							<img src={src} alt={alt} className="max-h-[90vh] max-w-[90vw] object-contain" loading="lazy" />
						)}
					</div>
