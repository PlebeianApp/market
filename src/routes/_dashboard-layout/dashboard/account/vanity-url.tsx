...
import { vanityActions, type VanityEntry } from '@/lib/stores/vanity'
                    ...
                    <>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-sm text-muted-foreground">
                                            Expires: {formatExpiration(currentVanity.validUntil).date}
                                        </span>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Choose a custom URL for your profile. This will be your shareable link.
                                </CardDescription>
                            </CardHeader>
