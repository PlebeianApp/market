/**
 * NIP-46 → applesauce `NostrConnectSigner` invariant-wrapper tests (ADR-0002 signer-migration amendment).
 *
...
describe('nostr-connect strict binding (ADR-0002 signer-migration amendment I1)', () => {
