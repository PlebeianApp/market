...
const makeAuction = (params: {
	...
	({
		...
		tags: [
			...
			['escrow_pubkey', '02aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'],
			['escrow_identity', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb'],
			['key_scheme', 'hd_p2pk'],
