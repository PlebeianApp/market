 ...
 * (ADR-0002 signer-migration amendment I5, fixes #996 finding H8).
 *
 ...
 * here.
 *
 * ADR-0002 signer-migration amendment I5 (persisted-session migration policy): the legacy
 ...
 * vault (ADR-0002 signer-migration amendment I5: "an intentional, user-visible forced re-login", never
