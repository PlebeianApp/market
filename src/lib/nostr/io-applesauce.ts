 ...
 *
 * Use `applesauce-relay`'s `RelayPool` for subscribe/fetch/publish. Relays
...
export const applesauceIo: NostrIo = {
	...
	async sign(template: EventTemplate): Promise<NostrEvent> {
		...
		// ADR-0002 signer-migration amendment I3 (signed-event identity): in-signer verification alone
