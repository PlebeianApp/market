/**
 * PasswordSigner session builder (ADR-0002 signer-migration amendment I5, signers-api-audit gap 4).
 *
 ...
 * lane (the signer registry, ADR-0002 signer-migration amendment §Decisions).
 */
