...
export type PlebeianServer = {
  ...
  RequestPath: (auctionEventId: string, auctionCoordinates: string, bidderRefundPubkey: string, intendedAmount: number) => Promise<RequestPathOutput>;
  SubmitBidToken: (auctionEventId: string, auctionCoordinates: string, bidEventId: string, grantId: string, lockPubkey: string, refundPubkey: string, mintUrl: string, amount: number, totalBidAmount: number, commitment: string, bidNonce: string, locktime: number, token: string) => Promise<SubmitBidTokenOutput>;
...
export class PlebeianServerClient implements PlebeianServer {
   ...
   */
  async GetBtcPriceSingle(
    currency: string, refresh?: boolean
  ): Promise<GetBtcPriceSingleOutput> {
   ...
   */
  async RequestPath(
    auctionEventId: string, auctionCoordinates: string, bidderRefundPubkey: string, intendedAmount: number
  ...
  async SubmitBidToken(
    auctionEventId: string, auctionCoordinates: string, bidEventId: string, grantId: string, lockPubkey: string, refundPubkey: string, mintUrl: string, amount: number, totalBidAmount: number, commitment: string, bidNonce: string, locktime: number, token: string
  ): Promise<SubmitBidTokenOutput> {
    return this.call("submit_bid_token", { auctionEventId, auctionCoordinates, bidEventId, grantId, lockPubkey, refundPubkey, mintUrl, amount, totalBidAmount, commitment, bidNonce, locktime, token });
  }
  ...
  async RequestSettlement(
    auctionEventId: string, auctionCoordinates?: string
  ): Promise<RequestSettlementOutput> {
