...
export class BlossomUploadService {
  private ndk: NDK
  private currentServer: BlossomServer

  constructor(ndk: NDK, serverUrl: string) {
    this.ndk = ndk
  ...
  async uploadFile(
    ...
    try {
      ...
      // CORS issues prevent direct uploads from browser to blossom servers
      // For now, we'll use data URLs as a working solution
      // TODO: Implement server-side proxy for proper NIP-96 uploads
