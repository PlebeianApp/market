...
const ShippingCountryTagSchema = z.tuple([z.literal('country'), iso3166Country, z.array(iso3166Country).optional()])
const ShippingServiceTagSchema = z.tuple([z.literal('service'), z.enum(['standard', 'express', 'overnight', 'pickup'])])

// Optional Tags
const ShippingCarrierTagSchema = z.tuple([z.literal('carrier'), z.string()])
const ShippingRegionTagSchema = z.tuple([z.literal('region'), iso3166Region, z.array(iso3166Region).optional()])
...
const ShippingLocationTagSchema = z.tuple([z.literal('location'), z.string()])
const ShippingGeohashTagSchema = z.tuple([z.literal('g'), geohash])
