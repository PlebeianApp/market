...
export const ItemTagSchema = z.tuple([z.literal('item'), z.string(), z.string().regex(/^\d+$/, 'Must be an integer')])
...
export const TypeTagSchema = z.tuple([z.literal('type'), z.enum([
...
export const PaymentMethodTagSchema = z.tuple([
  z.literal('payment'), 
  z.enum(['lightning', 'bitcoin', 'ecash']), 
