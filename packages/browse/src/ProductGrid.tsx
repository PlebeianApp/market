...
import { applyFilterState, defaultProductFilters, describeFilterState, hasActiveFilters, type ProductFilterState } from './filter'
...
export interface ProductGridProps {
	...
	problemsByCoordinate?: ReadonlyMap<string, readonly import('@plebeian/product').ParseProblem[]>
}
