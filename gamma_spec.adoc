...
Order processing and status updates use link:17.md[NIP-17] encrypted direct messages, with three event kinds serving different purposes:
...
* Merchant SHOULD have a link:https://github.com/nostr-protocol/nips/blob/master/89.md[NIP-89] kind `31989` event recommending their preferred service
