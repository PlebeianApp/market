...
* Order communication and processing via link:17.md[NIP-17] encrypted messages
...
* Drafts following link:37.md[NIP-37]
...
* Application preferences via link:89.md[NIP-89]
...
. Application Preferences (link:89.md[NIP-89]):
...
A specialized event type using link:51.md[NIP-51] like list format to organize related products into groups. Collections allow merchants or any user to create meaningful product groupings and share common attributes that products can also reference, establishing one-to-many relationships.
...
* Merchant SHOULD have a link:89.md[NIP-89] kind `31989` event recommending their preferred service
...
* Merchant's link:89.md[NIP-89] application preferences SHOULD be respected
...
. Message threading should follow link:10.md[NIP-10] conventions when replies are needed.