...
function testHashtagsAndReactionsAlwaysShow() {
	...
	try {
		...
		const reactionsAlwaysReturnsDiv =
			reactionsCode.includes('return (') && reactionsCode.includes('<span className="text-gray-500">Reactions:</span>')
		const hashtagsAlwaysReturnsDiv =
			hashtagsCode.includes('return (') && hashtagsCode.includes('<span className="text-gray-500">Hashtags:</span>')
