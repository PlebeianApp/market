...
| 0018         | Wallet Recovery via NUT-09 Restore-from-Mint (+NUT-27 Mint Backup)      | Proposed | `ADR-0018-wallet-recovery-nut09-restore-from-mint.md`               | Branch `adr/018-recovery`. D3/D4 of wallet research handover.                                                                                           |
