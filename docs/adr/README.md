...
| 0017         | Cashu Wallet — Dependencies, Recovery, and Synchronization              | Proposed | `ADR-0017-cashu-wallet-deps-recovery-sync.md`                       | Branch `adr/cashu-wallet`. Bundles the previously proposed (never merged) ADR-017 dependency stack, ADR-018 NUT-09/NUT-27 recovery, and ADR-019 synchronization into one ADR per team decision 2026-08-27. D2–D7 of wallet research handover. |
