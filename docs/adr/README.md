...
> **This file is the single source of truth for ADR numbering.** Any PR that adds, renumbers, or changes the status of an ADR **must** update this file in the same PR.
...
| 0004         | Unified Auction Settlement Descriptor with Participant-Role Enumeration | Proposed | `ADR-0004-auction-settlement-descriptor.md`                         | PR #1144 (settlement-steps). **PR #1230 (direct-lightning-bid-funding) also claimed 0004 — closed 2026-08-18; claim is moot.**                                                       |
...
| 0008         | Signer Migration to applesauce-signers                                  | Proposed | `ADR-0008-signer-migration-applesauce-signers.md`                   | PR #1252 (branch `adr/022-signer-migration`). All 4 login paths NDK → applesauce-signers. Prerequisite landed: applesauce-core ^6.2.0 (#1253). Was ADR-0022 — renumbered 2026-09-01. |
...
- **0009–0012** are the recommended single-digit range for new ADRs (0008 is now taken by ADR-0008, Signer Migration).
...
- **ADR-0004 collision (resolved):** Three PRs originally claimed 0004: #1144 (settlement-steps), #1198 (CMS), and #1205/#1230 (lightning-bid-funding). CMS was renumbered to 0006. Lightning-bid-funding (#1230, closed 2026-08-18) claimed 0004 but never merged — claim is moot; #1144's ADR keeps 0004.
...
- **ADR-0015 collision (resolved):** PR #1207 (production-safe NDK filters, Accepted) vs PR #1174 (staging-relay-recovery, CLOSED). The closed PR's ADR was never merged. If revived, it needs a new number.
- **ADR-0016 collision (open):** Master's ADR-0016 (Zap NDK isolation, PR #1211, Accepted) vs PR #1215 (product-orthogonal-dimensions). #1215 needs renumbering to 0009.
- **ADR-0022 → ADR-0008 renumbering (2026-09-01):** The signer-migration ADR (PR #1252) was originally numbered 0022, violating the single-digit rule. Renumbered to 0008. The 0008 slot had been informally earmarked for the closed #1230's renumbering, but that PR never merged; the slot was free.
