...
| 0015         | Production-safe NDK Filter Handling and Stable Kind-0 Profile Fetching  | Accepted | `ADR-0015-production-safe-ndk-filters-and-stable-kind-0-fetching.md` | PR #1207 (fix/ai-guardrails-profile-unload). **Was also claimed by PR #1174 (staging-relay-recovery, CLOSED) — that ADR needs renumbering if revived.**                                                               |
| 0016         | Zap NDK External Relay Isolation                                        | Accepted | `ADR-0016-zap-ndk-external-relay-isolation.md`                       | PR #1211. Legacy cluster (0013–0016) — reserved. **Conflict: PR #1215 (product-orthogonal-dimensions) also claims 0016 — needs renumbering to 0009.**                                                                 |
| (unnumbered) | Add Product Workflow Boundaries                                         | Accepted | `ADR-add-product-workflow-boundaries.md`                             | Predates the numbering system.                                                                                                                                                                                        |
| 0020         | Auctions Are Applesauce-Native From Day One (Kind 30408)                | Proposed | `ADR-0020-auctions-applesauce-native-architecture.md`                | Branch `adr/020-auctions-e2e`. Greenfield auctions: reads via EventStore/QueryStore, writes via io.ts seam. Implementation detail in `docs/designs/applesauce-auctions-migration.md`. D8 of wallet research handover. |
| 0021         | Feature Quality Gate — Playwright E2E with Video Evidence               | Proposed | `ADR-0021-feature-quality-gate-playwright-e2e.md`                    | Branch `adr/020-auctions-e2e`. Maintainer standard (Felix, 2026-08-27): every feature PR ships a Playwright E2E spec + published video as the final quality gate. Isolation per ADR-0005.                             |
