...
| 0022         | Signer Migration to applesauce-signers                                  | Proposed | `ADR-0022-signer-migration-applesauce-signers.md`                   | Branch `adr/022-signer-migration` (this PR). All 4 login paths NDK → applesauce-signers. Prerequisite: applesauce-core ^6.2.0. Signer audit (2026-08-27). |
